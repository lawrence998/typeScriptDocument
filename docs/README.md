...
<div class="home-item-title">
  <img class="home-icon" src="/typeScriptDocument/images/introduce-icon.png"/>
...
<div class="home-item">
<div class="home-item-title">
  <img class="home-icon" src="/typeScriptDocument/images/basics-icon.png"/>
...
<div class="home-item">
<div class="home-item-title">
  <img class="home-icon" src="/typeScriptDocument/images/project-icon.png"/>
...
<div class="home-item">
<div class="home-item-title">
  <img class="home-icon" src="/typeScriptDocument/images/configuration-icon.png"/>
...
<div class="home-item">
<div class="home-item-title">
  <img class="home-icon" src="/typeScriptDocument/images/actual-icon.png"/>
